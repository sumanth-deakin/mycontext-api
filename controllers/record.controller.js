...
exports.addRecord = function (req, res) {
    ...
    const new_record = new Record({
        ...
        cause_of_death_to_seer_site_recode: req.body.cause_of_death_to_seer_site_recode,
        ...
        seer_cause_specific_death_classification: req.body.seer_cause_specific_death_classification,
        seer_historic_stage_a: req.body.seer_historic_stage_a,
        seer_modified_ajcc_stage_3_edition: req.body.seer_modified_ajcc_stage_3_edition,
        seer_other_cause_specific_death_classification: req.body.seer_other_cause_specific_death_classification,
    ...
    new_record.save()
        .then(result => {
            ...
            Request.post({
                ...
                "url": "http://localhost:3000/api/com.mycontext.MedicalRecord",
...
exports.listRecords = function (req, res) {
    ...
    Record.find({}, ['name', 'cs_tumor_size', 'year_of_birth', 'gender', 'year_of_birth']).skip(from).limit(size).then(result => {
        res.json({
            success: true,
            data: result,
...
exports.listOwnerRecords = function (req, res) {
    ...
    const filter = "%7B%22owner%22%3A%20%22resource%3Acom.mycontext.Owner%23" + userId + "%22%7D";

    Request('http://localhost:3000/api/com.mycontext.MedicalRecord?filter=' + filter, function (error, response, body) {
    ...
    User.findOne(
        ...
        function (err, user) {
            ...
            const ownership = {
                ...
                "medicalRecord": "resource:com.mycontext.MedicalRecord#" + medicalrecordId,
                "newOwner": "resource:com.mycontext.Owner#" + user._id
            };

            Request.post({
                "headers": { "content-type": "application/json" },
                "url": "http://localhost:3000/api/com.mycontext.ChangeMedicalRecordOwner",
